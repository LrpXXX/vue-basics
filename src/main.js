...
import breadNav from '@/views/commonComponents/breadNav'
import topItem from '@/views/commonComponents/topItem'
...
import 'echarts/theme/macarons' // 引入自定义公用组件
Vue.use(breadNav)
Vue.component('bread-nav', breadNav) // 引入自定义公用组件
Vue.use(topItem)
Vue.component('top-item', topItem)

Vue.use(Api)
Vue.component('SvgIcon', SvgIcon) // echarts主题
